...
public class OrderDetails extends Product{
    ...
    public OrderDetails(String idOrder, int quantity, double priceDetails, int idProduct, String name, String description, double price, String image, int status, int idCatory, int quantiry) {
    ...
    public String toString() {
        return "OrderDetails{" + "idOrder=" + idOrder + ", quantity=" + quantityProduct + ", priceDetails=" + priceDetails + '}';
    }
